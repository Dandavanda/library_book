...
class FinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fine" do
    assert_difference('Fine.count') do
      post fines_url, params: { fine: { date_borrower: @fine.date_borrower, returns_id: @fine.returns_id } }
    end
  ...
  test "should update fine" do
    patch fine_url(@fine), params: { fine: { date_borrower: @fine.date_borrower, returns_id: @fine.returns_id } }
